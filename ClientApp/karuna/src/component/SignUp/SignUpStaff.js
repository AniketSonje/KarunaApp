...
//         <option value="Donor">As Donor</option>
//         <option value="Receiver">As Receiver</option>
//         <option value="Staff">Staff</option>
//       </select>
//       <p>Welcome: {selectedOption}</p>
//     </div>
//   );
// }
...
<MDBRow className='justify-content-center align-items-center m-5'>
  ...
  <MDBCard>
    <MDBCardBody className='px-4'>
      ...
      <h3 className="fw-bold mb-4 pb-2 pb-md-0 mb-md-5">Staff Registration Form</h3>
      ...
      <MDBRow>
        ...
        <MDBCol md='6'>
          <MDBInput wrapperClass='mb-4' placeholder='Staff Role' size='lg' id='form3' type='text'/>
        </MDBCol>
      ...
      <br></br>
      <p><Link to={"/login"}><button type="button">Sign Up</button></Link></p>
