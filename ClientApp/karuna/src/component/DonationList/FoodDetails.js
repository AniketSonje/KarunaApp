    ...
    <MDBContainer fluid className='d-flex align-items-center justify-content-center bg-image' style={{backgroundImage: 'url()'}}>
      ...
      <MDBCard className='m-5' style={{maxWidth: '600px'}}>
        <MDBCardBody className='px-5'>
          <h2 className="text-uppercase text-center mb-5">Food Details</h2>
          ...
          <Link to={"/ReceiverDashboard"}><MDBBtn className='mb-4 w-100 gradient-custom-4' size='lg'>Accept</MDBBtn></Link>
        </MDBCardBody>
      </MDBCard>
    </MDBContainer>
  );
