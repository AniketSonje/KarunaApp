    ...
    <div className='pagecontent'>
        ...
        <div>  
            ...
            <Card.Body>
                ...
                <Link to={"/FoodDonation"}><Button variant="primary">Donate </Button></Link>
            </Card.Body>
            </Card>
        </div>
        &nbsp;&nbsp;&nbsp;
        <div>
            ...
            <Card.Body>
                <Card.Title>Clothing Donation</Card.Title>
                Some quick example text to build on the card title and make up the
                bulk of the card's content.
                {/* <Card.Text>
                Some quick example text to build on the card title and make up the
                ...
                <Link to={"/ClothDonation"}><Button variant="primary">Donate </Button></Link>
            </Card.Body>
            </Card>
        </div>
        &nbsp;&nbsp;&nbsp;
        <div>
            ...
            <Card.Body>
                <Card.Title>Furniture Donation</Card.Title>
                Some quick example text to build on the card title and make up the
                bulk of the card's content.
                {/* <Card.Text>
                Some quick example text to build on the card title and make up the
                ...
                <Link to={"/FurnitureDonation"}><Button variant="primary">Donate </Button></Link>
            </Card.Body>
            </Card>
        </div>
        &nbsp;&nbsp;&nbsp;
        <div>  
            ...
            <Card.Body>
                <Card.Title>Toys Donation</Card.Title>
                Some quick example text to build on the card title and make up the
                bulk of the card's content.
                {/* <Card.Text>
                Some quick example text to build on the card title and make up the
                ...
                <Link to={"/ToyDonation"}><Button variant="primary">Donate </Button></Link>
            </Card.Body>
            </Card>
        </div>
